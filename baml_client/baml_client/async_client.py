...
class BamlAsyncClient:
    ...
    async def AnalyzeNotebookStructure(self, notebook_content: str,
        ...
        if 'on_tick' in baml_options:
            ...
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="AnalyzeNotebookStructure", args={
    ...
    async def AnalyzeWorkStreamCoordination(self, theory_artifacts: str,technical_artifacts: str,narrative_artifacts: str,governance_artifacts: str,
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="AnalyzeWorkStreamCoordination", args={
    ...
    async def BusinessContextAgent(self, business_question: str,success_criteria: str,timeline: str,budget: str,risk_tolerance: str,persona_id: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="BusinessContextAgent", args={
    ...
    async def CheckManifestoCompliance(self, work_artifacts: str,manifesto_sections: typing.List[str],
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="CheckManifestoCompliance", args={
    ...
    async def CongestionManagementAgent(self, current_traffic: typing.Dict[str, int],lock_queues: typing.Dict[str, int],
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="CongestionManagementAgent", args={
    ...
    async def DataFetcherAgent(self, data_sources: typing.List["types.DataSource"],security_requirements: typing.List[str],
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="DataFetcherAgent", args={
                "data_sources": data_sources,"security_requirements": security_requirements,
            })
            return typing.cast(str, result.cast_to(types, types, stream_types, False, __runtime__))
    async def DataParserAgent(self, raw_data: str,data_format: str,schema_hints: typing.List[str],
        baml_options: BamlCallOptions = {},
    ) -> types.ParsedData:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="DataParserAgent", args={
    ...
    async def DataTransformerAgent(self, source_data: types.ParsedData,target_schema: typing.Dict[str, str],business_rules: typing.List[str],
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="DataTransformerAgent", args={
    ...
    async def DecisionSupportAgent(self, current_situation: str,available_options: typing.List["types.RouteOption"],constraints: typing.Dict[str, str],
        baml_options: BamlCallOptions = {},
    ) -> str:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="DecisionSupportAgent", args={
    ...
    async def ETKLGuruAgent(self, project_artifacts: str,current_work_context: str,proposed_changes: str,
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="ETKLGuruAgent", args={
    ...
    async def EconomicOptimizationAgent(self, market_data: typing.Dict[str, float],transport_rates: typing.Dict[str, float],routing_options: typing.List["types.RouteOption"],
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="EconomicOptimizationAgent", args={
    ...
    async def FeasibilityAnalyzerAgent(self, business_context: types.BusinessContext,recommended_sources: typing.List["types.DataSourceRecommendation"],
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="FeasibilityAnalyzerAgent", args={
    ...
    async def HydrologicalRiskAgent(self, waterway_segments: typing.List[str],forecast_period_days: int,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="HydrologicalRiskAgent", args={
    ...
    async def JupyterStorytellerAgent(self, notebook_content: str,notebook_type: str,target_audience: str,
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="JupyterStorytellerAgent", args={
    ...
    async def MultiModalOptimizationAgent(self, origin: str,destination: str,commodity: str,quantity_tons: float,service_requirements: typing.Dict[str, str],
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="MultiModalOptimizationAgent", args={
    ...
    async def NavigationIntelligenceAgent(self, routing_request: types.RoutingRequest,current_conditions: types.WaterwayConditions,
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="NavigationIntelligenceAgent", args={
    ...
    async def OptimizeStoryFlow(self, current_structure: types.NotebookStructure,target_story_type: str,
        baml_options: BamlCallOptions = {},
    ) -> types.StorytellingPlan:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="OptimizeStoryFlow", args={
    ...
    async def PersonaResponseAgent(self, base_response: str,persona_id: str,interaction_level: str,technical_depth: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="PersonaResponseAgent", args={
                "base_response": base_response,"persona_id": persona_id,"interaction_level": interaction_level,"technical_depth": technical_depth,
            })
            return typing.cast(str, result.cast_to(types, types, stream_types, False, __runtime__))
    async def PlatformCapabilityAgent(self, data_sources: typing.List[str],requirements: typing.List[str],
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="PlatformCapabilityAgent", args={
    ...
    async def SOWGeneratorAgent(self, business_context: types.BusinessContext,selected_sources: typing.List["types.DataSourceRecommendation"],feasibility_analysis: types.FeasibilityAnalysis,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="SOWGeneratorAgent", args={
    ...
    async def SOWInterpreterAgent(self, sow_document: str,document_format: str,
        baml_options: BamlCallOptions = {},
    ) -> types.DataContract:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="SOWInterpreterAgent", args={
    ...
    async def SecurityDecisionAgent(self, operation_context: str,risk_assessment: str,data_sensitivity: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="SecurityDecisionAgent", args={
    ...
    async def SemanticIntegratorAgent(self, transformed_data: types.ParsedData,business_domain: str,existing_ontologies: typing.List[str],
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="SemanticIntegratorAgent", args={
    ...
    async def SourceDiscoveryAgent(self, business_context: types.BusinessContext,platform_capabilities: typing.List[str],
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="SourceDiscoveryAgent", args={
    ...
    async def SupervisorAgent(self, sow_document: str,document_format: str,human_feedback: typing.List[str],
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="SupervisorAgent", args={
    ...
    async def ValidateETKLPrinciples(self, work_item: str,work_type: str,
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="ValidateETKLPrinciples", args={
...
class BamlStreamClient:
    ...
    def AnalyzeNotebookStructure(self, notebook_content: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.NotebookStructure, types.NotebookStructure]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="AnalyzeNotebookStructure", args={
            "notebook_content": notebook_content,
        })
        return baml_py.BamlStream[stream_types.NotebookStructure, types.NotebookStructure](
          result,
    ...
    def AnalyzeWorkStreamCoordination(self, theory_artifacts: str,technical_artifacts: str,narrative_artifacts: str,governance_artifacts: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[typing.List["stream_types.ETKLWorkStreamAnalysis"], typing.List["types.ETKLWorkStreamAnalysis"]]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="AnalyzeWorkStreamCoordination", args={
            "theory_artifacts": theory_artifacts,"technical_artifacts": technical_artifacts,"narrative_artifacts": narrative_artifacts,"governance_artifacts": governance_artifacts,
        })
        return baml_py.BamlStream[typing.List["stream_types.ETKLWorkStreamAnalysis"], typing.List["types.ETKLWorkStreamAnalysis"]](
          result,
    ...
    def BusinessContextAgent(self, business_question: str,success_criteria: str,timeline: str,budget: str,risk_tolerance: str,persona_id: str,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="BusinessContextAgent", args={
            "business_question": business_question,"success_criteria": success_criteria,"timeline": timeline,"budget": budget,"risk_tolerance": risk_tolerance,"persona_id": persona_id,
        })
        return baml_py.BamlStream[stream_types.BusinessContext, types.BusinessContext](
          result,
    ...
    def CheckManifestoCompliance(self, work_artifacts: str,manifesto_sections: typing.List[str],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[typing.List["stream_types.ETKLManifestoCompliance"], typing.List["types.ETKLManifestoCompliance"]]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="CheckManifestoCompliance", args={
            "work_artifacts": work_artifacts,"manifesto_sections": manifesto_sections,
        })
        return baml_py.BamlStream[typing.List["stream_types.ETKLManifestoCompliance"], typing.List["types.ETKLManifestoCompliance"]](
          result,
    ...
    def CongestionManagementAgent(self, current_traffic: typing.Dict[str, int],lock_queues: typing.Dict[str, int],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[typing.List["stream_types.CongestionAlert"], typing.List["types.CongestionAlert"]]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="CongestionManagementAgent", args={
            "current_traffic": current_traffic,"lock_queues": lock_queues,
        })
        return baml_py.BamlStream[typing.List["stream_types.CongestionAlert"], typing.List["types.CongestionAlert"]](
          result,
    ...
    def DataFetcherAgent(self, data_sources: typing.List["types.DataSource"],security_requirements: typing.List[str],
        ...
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="DataFetcherAgent", args={
            "data_sources": data_sources,"security_requirements": security_requirements,
        })
    ...
    def DataParserAgent(self, raw_data: str,data_format: str,schema_hints: typing.List[str],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.ParsedData, types.ParsedData]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="DataParserAgent", args={
            "raw_data": raw_data,"data_format": data_format,"schema_hints": schema_hints,
        })
        return baml_py.BamlStream[stream_types.ParsedData, types.ParsedData](
          result,
    ...
    def DataTransformerAgent(self, source_data: types.ParsedData,target_schema: typing.Dict[str, str],business_rules: typing.List[str],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.TransformationStrategy, types.TransformationStrategy]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="DataTransformerAgent", args={
            "source_data": source_data,"target_schema": target_schema,"business_rules": business_rules,
        })
        return baml_py.BamlStream[stream_types.TransformationStrategy, types.TransformationStrategy](
          result,
    ...
    def DecisionSupportAgent(self, current_situation: str,available_options: typing.List["types.RouteOption"],constraints: typing.Dict[str, str],
        ...
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="DecisionSupportAgent", args={
            "current_situation": current_situation,"available_options": available_options,"constraints": constraints,
        })
        return baml_py.BamlStream[str, str](
          result,
    ...
    def ETKLGuruAgent(self, project_artifacts: str,current_work_context: str,proposed_changes: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.ETKLVisionAssessment, types.ETKLVisionAssessment]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="ETKLGuruAgent", args={
            "project_artifacts": project_artifacts,"current_work_context": current_work_context,"proposed_changes": proposed_changes,
        })
        return baml_py.BamlStream[stream_types.ETKLVisionAssessment, types.ETKLVisionAssessment](
          result,
    ...
    def EconomicOptimizationAgent(self, market_data: typing.Dict[str, float],transport_rates: typing.Dict[str, float],routing_options: typing.List["types.RouteOption"],
        ...
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="EconomicOptimizationAgent", args={
            "market_data": market_data,"transport_rates": transport_rates,"routing_options": routing_options,
        })
        return baml_py.BamlStream[typing.List["stream_types.MarketOpportunity"], typing.List["types.MarketOpportunity"]](
          result,
    ...
    def FeasibilityAnalyzerAgent(self, business_context: types.BusinessContext,recommended_sources: typing.List["types.DataSourceRecommendation"],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.FeasibilityAnalysis, types.FeasibilityAnalysis]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="FeasibilityAnalyzerAgent", args={
            "business_context": business_context,"recommended_sources": recommended_sources,
        })
        return baml_py.BamlStream[stream_types.FeasibilityAnalysis, types.FeasibilityAnalysis](
          result,
    ...
    def HydrologicalRiskAgent(self, waterway_segments: typing.List[str],forecast_period_days: int,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[typing.Dict[str, types.RiskLevel], typing.Dict[str, types.RiskLevel]]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="HydrologicalRiskAgent", args={
            "waterway_segments": waterway_segments,"forecast_period_days": forecast_period_days,
        })
        return baml_py.BamlStream[typing.Dict[str, types.RiskLevel], typing.Dict[str, types.RiskLevel]](
          result,
    ...
    def JupyterStorytellerAgent(self, notebook_content: str,notebook_type: str,target_audience: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.StorytellingPlan, types.StorytellingPlan]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="JupyterStorytellerAgent", args={
            "notebook_content": notebook_content,"notebook_type": notebook_type,"target_audience": target_audience,
        })
        return baml_py.BamlStream[stream_types.StorytellingPlan, types.StorytellingPlan](
          result,
    ...
    def MultiModalOptimizationAgent(self, origin: str,destination: str,commodity: str,quantity_tons: float,service_requirements: typing.Dict[str, str],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[typing.List["stream_types.RouteOption"], typing.List["types.RouteOption"]]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="MultiModalOptimizationAgent", args={
            "origin": origin,"destination": destination,"commodity": commodity,"quantity_tons": quantity_tons,"service_requirements": service_requirements,
        })
        return baml_py.BamlStream[typing.List["stream_types.RouteOption"], typing.List["types.RouteOption"]](
          result,
    ...
    def NavigationIntelligenceAgent(self, routing_request: types.RoutingRequest,current_conditions: types.WaterwayConditions,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.NavigationRecommendation, types.NavigationRecommendation]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="NavigationIntelligenceAgent", args={
            "routing_request": routing_request,"current_conditions": current_conditions,
        })
        return baml_py.BamlStream[stream_types.NavigationRecommendation, types.NavigationRecommendation](
          result,
    ...
    def OptimizeStoryFlow(self, current_structure: types.NotebookStructure,target_story_type: str,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="OptimizeStoryFlow", args={
            "current_structure": current_structure,"target_story_type": target_story_type,
        })
        return baml_py.BamlStream[stream_types.StorytellingPlan, types.StorytellingPlan](
          result,
    ...
    def PersonaResponseAgent(self, base_response: str,persona_id: str,interaction_level: str,technical_depth: str,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="PersonaResponseAgent", args={
            "base_response": base_response,"persona_id": persona_id,"interaction_level": interaction_level,"technical_depth": technical_depth,
        })
        return baml_py.BamlStream[str, str](
          result,
    ...
    def PlatformCapabilityAgent(self, data_sources: typing.List[str],requirements: typing.List[str],
        ...
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="PlatformCapabilityAgent", args={
            "data_sources": data_sources,"requirements": requirements,
        })
    ...
    def SOWGeneratorAgent(self, business_context: types.BusinessContext,selected_sources: typing.List["types.DataSourceRecommendation"],feasibility_analysis: types.FeasibilityAnalysis,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="SOWGeneratorAgent", args={
            "business_context": business_context,"selected_sources": selected_sources,"feasibility_analysis": feasibility_analysis,
        })
        return baml_py.BamlStream[stream_types.SOWContract, types.SOWContract](
          result,
    ...
    def SOWInterpreterAgent(self, sow_document: str,document_format: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.DataContract, types.DataContract]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="SOWInterpreterAgent", args={
            "sow_document": sow_document,"document_format": document_format,
        })
        return baml_py.BamlStream[stream_types.DataContract, types.DataContract](
          result,
    ...
    def SecurityDecisionAgent(self, operation_context: str,risk_assessment: str,data_sensitivity: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.SecurityDecision, types.SecurityDecision]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="SecurityDecisionAgent", args={
            "operation_context": operation_context,"risk_assessment": risk_assessment,"data_sensitivity": data_sensitivity,
        })
        return baml_py.BamlStream[stream_types.SecurityDecision, types.SecurityDecision](
          result,
    ...
    def SemanticIntegratorAgent(self, transformed_data: types.ParsedData,business_domain: str,existing_ontologies: typing.List[str],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.SemanticAnnotation, types.SemanticAnnotation]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="SemanticIntegratorAgent", args={
            "transformed_data": transformed_data,"business_domain": business_domain,"existing_ontologies": existing_ontologies,
        })
        return baml_py.BamlStream[stream_types.SemanticAnnotation, types.SemanticAnnotation](
          result,
    ...
    def SourceDiscoveryAgent(self, business_context: types.BusinessContext,platform_capabilities: typing.List[str],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[typing.List["stream_types.DataSourceRecommendation"], typing.List["types.DataSourceRecommendation"]]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="SourceDiscoveryAgent", args={
            "business_context": business_context,"platform_capabilities": platform_capabilities,
        })
        return baml_py.BamlStream[typing.List["stream_types.DataSourceRecommendation"], typing.List["types.DataSourceRecommendation"]](
          result,
    ...
    def SupervisorAgent(self, sow_document: str,document_format: str,human_feedback: typing.List[str],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.GeneratedPipeline, types.GeneratedPipeline]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="SupervisorAgent", args={
            "sow_document": sow_document,"document_format": document_format,"human_feedback": human_feedback,
        })
        return baml_py.BamlStream[stream_types.GeneratedPipeline, types.GeneratedPipeline](
          result,
    ...
    def ValidateETKLPrinciples(self, work_item: str,work_type: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[typing.List["stream_types.ETKLPrincipleViolation"], typing.List["types.ETKLPrincipleViolation"]]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="ValidateETKLPrinciples", args={
            "work_item": work_item,"work_type": work_type,
        })
        return baml_py.BamlStream[typing.List["stream_types.ETKLPrincipleViolation"], typing.List["types.ETKLPrincipleViolation"]](
          result,
...
class BamlHttpRequestClient:
    ...
    async def AnalyzeNotebookStructure(self, notebook_content: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="AnalyzeNotebookStructure", args={
            "notebook_content": notebook_content,
        }, mode="request")
        return result
    async def AnalyzeSourceFitness(self, source_metadata: types.DataSourceMetadata,business_context: typing.Dict[str, str],
    ...
    async def AnalyzeWorkStreamCoordination(self, theory_artifacts: str,technical_artifacts: str,narrative_artifacts: str,governance_artifacts: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="AnalyzeWorkStreamCoordination", args={
            "theory_artifacts": theory_artifacts,"technical_artifacts": technical_artifacts,"narrative_artifacts": narrative_artifacts,"governance_artifacts": governance_artifacts,
        }, mode="request")
        return result
    async def BusinessContextAgent(self, business_question: str,success_criteria: str,timeline: str,budget: str,risk_tolerance: str,persona_id: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="BusinessContextAgent", args={
            "business_question": business_question,"success_criteria": success_criteria,"timeline": timeline,"budget": budget,"risk_tolerance": risk_tolerance,"persona_id": persona_id,
        }, mode="request")
        return result
    async def CheckManifestoCompliance(self, work_artifacts: str,manifesto_sections: typing.List[str],
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="CheckManifestoCompliance", args={
            "work_artifacts": work_artifacts,"manifesto_sections": manifesto_sections,
        }, mode="request")
        return result
    async def CongestionManagementAgent(self, current_traffic: typing.Dict[str, int],lock_queues: typing.Dict[str, int],
    ...
    async def DataFetcherAgent(self, data_sources: typing.List["types.DataSource"],security_requirements: typing.List[str],
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="DataFetcherAgent", args={
            "data_sources": data_sources,"security_requirements": security_requirements,
        }, mode="request")
        return result
    async def DataParserAgent(self, raw_data: str,data_format: str,schema_hints: typing.List[str],
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="DataParserAgent", args={
            "raw_data": raw_data,"data_format": data_format,"schema_hints": schema_hints,
        }, mode="request")
        return result
    async def DataTransformerAgent(self, source_data: types.ParsedData,target_schema: typing.Dict[str, str],business_rules: typing.List[str],
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="DataTransformerAgent", args={
            "source_data": source_data,"target_schema": target_schema,"business_rules": business_rules,
        }, mode="request")
        return result
    async def DecisionSupportAgent(self, current_situation: str,available_options: typing.List["types.RouteOption"],constraints: typing.Dict[str, str],
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="DecisionSupportAgent", args={
            "current_situation": current_situation,"available_options": available_options,"constraints": constraints,
        }, mode="request")
        return result
    async def DiscoverFromScratch(self, request: types.ZeroStartDiscovery,
    ...
    async def ETKLGuruAgent(self, project_artifacts: str,current_work_context: str,proposed_changes: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ETKLGuruAgent", args={
            "project_artifacts": project_artifacts,"current_work_context": current_work_context,"proposed_changes": proposed_changes,
        }, mode="request")
        return result
    async def EconomicOptimizationAgent(self, market_data: typing.Dict[str, float],transport_rates: typing.Dict[str, float],routing_options: typing.List["types.RouteOption"],
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="EconomicOptimizationAgent", args={
            "market_data": market_data,"transport_rates": transport_rates,"routing_options": routing_options,
        }, mode="request")
        return result
    async def FeasibilityAnalyzerAgent(self, business_context: types.BusinessContext,recommended_sources: typing.List["types.DataSourceRecommendation"],
    ...
    async def HydrologicalRiskAgent(self, waterway_segments: typing.List[str],forecast_period_days: int,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="HydrologicalRiskAgent", args={
            "waterway_segments": waterway_segments,"forecast_period_days": forecast_period_days,
        }, mode="request")
        return result
    async def JupyterStorytellerAgent(self, notebook_content: str,notebook_type: str,target_audience: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="JupyterStorytellerAgent", args={
            "notebook_content": notebook_content,"notebook_type": notebook_type,"target_audience": target_audience,
        }, mode="request")
        return result
    async def MultiModalOptimizationAgent(self, origin: str,destination: str,commodity: str,quantity_tons: float,service_requirements: typing.Dict[str, str],
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="MultiModalOptimizationAgent", args={
            "origin": origin,"destination": destination,"commodity": commodity,"quantity_tons": quantity_tons,"service_requirements": service_requirements,
        }, mode="request")
        return result
    async def NavigationIntelligenceAgent(self, routing_request: types.RoutingRequest,current_conditions: types.WaterwayConditions,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="NavigationIntelligenceAgent", args={
            "routing_request": routing_request,"current_conditions": current_conditions,
        }, mode="request")
        return result
    async def OptimizeStoryFlow(self, current_structure: types.NotebookStructure,target_story_type: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="OptimizeStoryFlow", args={
            "current_structure": current_structure,"target_story_type": target_story_type,
        }, mode="request")
        return result
    async def ParseExecutiveTarget(self, target_description: str,enterprise_context: typing.Dict[str, str],
    ...
    async def PersonaResponseAgent(self, base_response: str,persona_id: str,interaction_level: str,technical_depth: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="PersonaResponseAgent", args={
            "base_response": base_response,"persona_id": persona_id,"interaction_level": interaction_level,"technical_depth": technical_depth,
        }, mode="request")
        return result
    async def PlatformCapabilityAgent(self, data_sources: typing.List[str],requirements: typing.List[str],
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="PlatformCapabilityAgent", args={
            "data_sources": data_sources,"requirements": requirements,
        }, mode="request")
        return result
    async def PrepareWorkflowData(self, discovered_sources: typing.List["types.DataSourceMetadata"],canvas_data: typing.Dict[str, str],
    ...
    async def SOWGeneratorAgent(self, business_context: types.BusinessContext,selected_sources: typing.List["types.DataSourceRecommendation"],feasibility_analysis: types.FeasibilityAnalysis,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="SOWGeneratorAgent", args={
            "business_context": business_context,"selected_sources": selected_sources,"feasibility_analysis": feasibility_analysis,
        }, mode="request")
        return result
    async def SOWInterpreterAgent(self, sow_document: str,document_format: str,
    ...
    async def SecurityDecisionAgent(self, operation_context: str,risk_assessment: str,data_sensitivity: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="SecurityDecisionAgent", args={
            "operation_context": operation_context,"risk_assessment": risk_assessment,"data_sensitivity": data_sensitivity,
        }, mode="request")
        return result
    async def SemanticIntegratorAgent(self, transformed_data: types.ParsedData,business_domain: str,existing_ontologies: typing.List[str],
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="SemanticIntegratorAgent", args={
            "transformed_data": transformed_data,"business_domain": business_domain,"existing_ontologies": existing_ontologies,
        }, mode="request")
        return result
    async def SourceDiscoveryAgent(self, business_context: types.BusinessContext,platform_capabilities: typing.List[str],
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="SourceDiscoveryAgent", args={
            "business_context": business_context,"platform_capabilities": platform_capabilities,
        }, mode="request")
        return result
    async def SupervisorAgent(self, sow_document: str,document_format: str,human_feedback: typing.List[str],
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="SupervisorAgent", args={
            "sow_document": sow_document,"document_format": document_format,"human_feedback": human_feedback,
        }, mode="request")
        return result
    async def ValidateETKLPrinciples(self, work_item: str,work_type: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ValidateETKLPrinciples", args={
            "work_item": work_item,"work_type": work_type,
        }, mode="request")
        return result
