...
class CellMove(BaseModel):
    current_position: typing.Optional[int] = None
    suggested_position: typing.Optional[int] = None
    reason: typing.Optional[str] = None
    cell_type: typing.Optional[str] = None
    content_summary: typing.Optional[str] = None
...
class ETKLCoordinationPlan(BaseModel):
    coordination_strategy: typing.Optional[str] = None
...
class ETKLManifestoCompliance(BaseModel):
    manifesto_section: typing.Optional[str] = None
...
class ETKLPrincipleViolation(BaseModel):
    principle_violated: typing.Optional[str] = None
    severity: typing.Optional[str] = None
    location: typing.Optional[str] = None
    description: typing.Optional[str] = None
    business_impact: typing.Optional[str] = None
    corrective_action: typing.Optional[str] = None
    priority: typing.Optional[int] = None

class ETKLVisionAssessment(BaseModel):
    overall_alignment_score: typing.Optional[float] = None
    theoretical_consistency: typing.Optional[float] = None
    technical_implementation: typing.Optional[float] = None
    narrative_coherence: typing.Optional[float] = None
    governance_compliance: typing.Optional[float] = None
...
class ETKLWorkStreamAnalysis(BaseModel):
    work_stream: typing.Optional[str] = None
...
class NotebookSection(BaseModel):
    ...
    cell_range: typing.Optional[str] = None
    cell_types: typing.List[str]
    purpose: typing.Optional[str] = None
    story_function: typing.Optional[str] = None
    narrative_quality: typing.Optional[float] = None
...
class NotebookStructure(BaseModel):
    ...
    story_flow_score: typing.Optional[float] = None
